...
{
       0,    41,    41,    52,    58,    61,    66,    73,    75,    83,
      87,    90,    97,   105,   114,   118,   124,   131,   138,   144,
...
#line 1284 "src/tpcas.c"
    break;

  case 10: /* DeclFoncts: DeclFonct  */
#line 87 "src/tpcas.y"
                    {(yyval.node) = (yyvsp[0].node);}
#line 1290 "src/tpcas.c"
    break;
...
#line 1313 "src/tpcas.c"
    break;

  case 13: /* EnTeteFonct: VOID IDENT '(' Parametres ')'  */
#line 105 "src/tpcas.y"
                                     {
                                    (yyval.node) = makeNode(heading);
...
#line 1505 "src/tpcas.c"
    break;

  case 33: /* Exp: TB  */
#line 207 "src/tpcas.y"
            {(yyval.node) = (yyvsp[0].node);}
#line 1511 "src/tpcas.c"
    break;
...
#line 1589 "src/tpcas.c"
    break;

  case 43: /* T: F  */
#line 246 "src/tpcas.y"
            {(yyval.node) = (yyvsp[0].node);}
#line 1595 "src/tpcas.c"
    break;
...
#line 1614 "src/tpcas.c"
    break;

  case 46: /* F: '(' Exp ')'  */
#line 257 "src/tpcas.y"
                    {(yyval.node) = (yyvsp[-1].node);}
#line 1620 "src/tpcas.c"
    break;
...
#line 1638 "src/tpcas.c"
    break;

  case 49: /* F: LValue  */
#line 266 "src/tpcas.y"
                {(yyval.node) = (yyvsp[0].node);}
#line 1644 "src/tpcas.c"
    break;
...
#line 1697 "src/tpcas.c"
    break;

  case 56: /* ListExp: Exp  */
#line 296 "src/tpcas.y"
            {(yyval.node) = (yyvsp[0].node);}
#line 1703 "src/tpcas.c"
    break;


#line 1707 "src/tpcas.c"
